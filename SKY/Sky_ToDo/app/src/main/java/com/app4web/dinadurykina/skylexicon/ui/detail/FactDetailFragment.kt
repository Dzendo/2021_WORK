package com.app4web.dinadurykina.skylexicon.ui.detail
...
import com.app4web.dinadurykina.skylexicon.databinding.FactDetailFragmentBinding
import timber.log.Timber
import com.app4web.dinadurykina.skylexicon.R
import dagger.hilt.android.AndroidEntryPoint

// Вызывается NavHostFragment-ом  из SkyFragment.kt при нажатии на строку или на fab
// сюда передано управление, что бы разместить этот FactDetailFragment в отведенном SkyActivity месте под фрагмент
@AndroidEntryPoint
...
/*    private val factDetailViewModel: FactDetailViewModel by viewModels {
        SkyInjectorUtils.provideFactDetailViewModelFactory(requireContext(), args.factID, args.paemi)
    }*/
   ...
   // }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Timber.i("Sky FactDetailFragment onCreate ")
    ...
    override fun onCreateView(          // Андроид передает сюда стандартные параметры
        ...
        Timber.i("SkyFactDetailFragment onCreateView ")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        Timber.i("Sky FactDetailFragment onViewCreated")
