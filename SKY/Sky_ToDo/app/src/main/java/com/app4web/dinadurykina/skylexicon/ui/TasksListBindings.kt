 ...
 */
package com.app4web.dinadurykina.skylexicon.ui
...
fun setItems(listView: RecyclerView, items: List<FactTable>?) {
    items?.let {
       // (listView.adapter as SkyPageAdapterTable).submitList(items)
       // (listView.adapter as SkyPageAdapterTable).submitData(items)
    }
}
/*
