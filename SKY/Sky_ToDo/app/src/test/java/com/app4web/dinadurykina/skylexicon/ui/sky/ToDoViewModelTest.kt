...
import com.app4web.dinadurykina.skylexicon.getOrAwaitValue
...
class SkyViewModelTest {
    ...
    // Subject under test
    private lateinit var toDoViewModel: SkyViewModel
    // XXXXX  val tasksViewModel = TasksViewModel(ApplicationProvider.getApplicationContext()) xxx- нужен свежий
    @Before
    fun setUp() {
        toDoViewModel = SkyViewModel(ApplicationProvider.getApplicationContext())
    }
